        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.camera_alt_outlined, size: 28, color: AppColors.accent.withValues(alpha: 0.6)),
                      const SizedBox(height: 4),
                      Text(T.tr('addPhoto'), style: TextStyle(fontSize: 12, color: AppColors.accent.withValues(alpha: 0.6))),
                    ],
                  ),
                ),
              ),
              const SizedBox(height: 8),
              Center(child: Text(T.tr('optional'), style: Theme.of(context).textTheme.bodySmall)),
              const SizedBox(height: 48),
              // Name
              Text(T.tr('nameLabel'), style: Theme.of(context).textTheme.headlineSmall),
              const SizedBox(height: 20),
              TextFormField(
              ...
              // Birth year
              Text(T.tr('birthYearLabel'), style: Theme.of(context).textTheme.headlineSmall),
              const SizedBox(height: 20),
              TextFormField(
                ...
                maxLength: 4,
                style: Theme.of(context).textTheme.bodyLarge,
                decoration: InputDecoration(hintText: T.tr('birthYearHint'), counterText: ''),
              ),
              const SizedBox(height: 36),
              // City
              Text(T.tr('cityLabel'), style: Theme.of(context).textTheme.headlineSmall),
              const SizedBox(height: 20),
              TextFormField(
