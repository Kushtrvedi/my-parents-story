...
class QuestionL10n {
  static const Map<String, Map<String, String>> _chapterTitles = {
    'hi': {
      'ch01': 'जड़ें और पारिवारिक उत्पत्ति',
      'ch02': 'जन्म और प्रारंभिक बचपन',
      'ch03': 'घर और पड़ोस',
      'ch04': 'स्कूल के दिन',
      'ch05': 'दोस्त और बड़े होना',
      'ch06': 'सपने और युवावस्था',
      'ch07': 'शिक्षा और सीख',
      'ch08': 'पहली नौकरी और करियर',
      'ch09': 'प्रेम और रिश्ता',
      'ch10': 'विवाह और साझेदारी',
      'ch11': 'पालन-पोषण और बच्चे',
      'ch12': 'पारिवारिक घर और परंपराएं',
      'ch13': 'चुनौतियाँ और मजबूती',
      'ch14': 'मोड़ और सफलताएँ',
      'ch15': 'मूल्य और विश्वास',
      'ch16': 'यात्राएं और जीवन दृष्टि',
      'ch17': 'जीवन के पाठ',
      'ch18': 'विचार और ज्ञान',
      'ch19': 'भावी पीढ़ियों के लिए आशाएं',
      'ch20': 'अंतिम विचार और संदेश',
    },
    'gu': {
      'ch01': 'મૂળ અને પારિવારિક ઉત્પત્તિ',
      'ch02': 'જન્મ અને પ્રારંભિક બાળપણ',
      'ch03': 'ઘર અને પડોશ',
      'ch04': 'શાળાના દિવસો',
      'ch05': 'મિત્રો અને મોટા થવું',
      'ch06': 'સ્વપ્નો અને યુવાની',
      'ch07': 'શિક્ષણ અને શીખવવું',
      'ch08': 'પ્રથમ નોકરી અને કારકિર્દી',
      'ch09': 'પ્રેમ અને સગાઈ',
      'ch10': 'લગ્ન અને ભાગીદારી',
      'ch11': 'પાલનપોષણ અને બાળકો',
      'ch12': 'પારિવારિક ઘર અને પરંપરાઓ',
      'ch13': 'પડકારો અને શક્તિ',
      'ch14': 'ટર્નિંગ પોઈન્ટ અને સફળતાઓ',
      'ch15': 'મૂલ્યો અને માન્યતાઓ',
      'ch16': 'પ્રવાસ અને દ્રષ્ટિકોણ',
      'ch17': 'જીવનના પાઠ',
      'ch18': 'વિચારો અને જ્ઞાન',
      'ch19': 'ભવિષ્યની પેઢીઓ માટે આશાઓ',
      'ch20': 'અંતિમ વિચારો અને વિદા',
    },
    'es': {
      'ch01': 'Raíces y Orígenes Familiares',
      'ch02': 'Nacimiento y Primera Infancia',
      'ch03': 'Hogar y Vecindario',
      'ch04': 'Días Escolares',
      'ch05': 'Amigos y Crecimiento',
      'ch06': 'Sueños y Juventud',
      'ch07': 'Educación y Aprendizaje',
      'ch08': 'Primer Empleo y Carrera',
      'ch09': 'Amor y Noviazgo',
      'ch10': 'Matrimonio y Compañerismo',
      'ch11': 'Crianza y Hijos',
      'ch12': 'Hogar Familiar y Tradiciones',
      'ch13': 'Desafíos y Resiliencia',
      'ch14': 'Puntos de Inflexión y Éxitos',
      'ch15': 'Valores y Creencias',
      'ch16': 'Viajes y Cosmovisión',
      'ch17': 'Lecciones de la Vida',
      'ch18': 'Reflexiones y Sabiduría',
      'ch19': 'Esperanzas para Futuras Generaciones',
      'ch20': 'Reflexiones Finales y Despedida',
    },
  };
  ...
  static const Map<String, Map<String, String>> _questionTranslations = {
    'hi': {
      ...
      'ch02_q05': 'अपने भाई-बहनों के साथ बचपन के दिनों की कोई खास याद बताइए।',
      ...
      // ch05
      'ch05_q01': 'बचपन में आप और आपके दोस्त शाम को क्या खेल खेलते थे?',
      'ch05_q02': 'बड़ा होने के दौरान आपने कौन सा सबसे बड़ा सबक सीखा?',

      // ch06
      'ch06_q01': 'युवावस्था में आपका सबसे बड़ा सपना क्या था?',
      'ch06_q02': 'आपको युवावस्था में किस तरह का संगीत या फिल्में पसंद थीं?',

      // ch07
      'ch07_q01': 'अपनी पढ़ाई के दौरान आपने अपने बारे में क्या नई बात जानी?',

      // ch08
      'ch08_q01': 'आपकी पहली नौकरी कौन सी थी और आपकी पहली कमाई कितनी थी?',
      'ch08_q02': 'पहली कमाई मिलने पर आपने सबसे पहले क्या खरीदा था?',
      ...
      'ch11_q02': 'अपने बच्चों को बड़े होते देखना आपको कैसा महसूस कराता है?',
      ...
      // ch15
      'ch15_q01': 'वे कौन से सिद्धांत हैं जिन्हें आपने जीवन भर हमेशा माना है?',

      // ch16
      'ch16_q01': 'आपने जो सबसे खूबसूरत यात्रा की थी, वह कौन सी थी?',
  ...
  static String getLocalizedChapterTitle(Chapter chapter, String localeCode) {
    final langMap = _chapterTitles[localeCode];
    if (langMap != null && langMap.containsKey(chapter.id)) {
      return langMap[chapter.id]!;
    }
    return chapter.title;
  }

  static String getLocalizedQuestion(Question question, String localeCode) {
    if (localeCode == 'en') return question.question;

    final langMap = _questionTranslations[localeCode];
    if (langMap != null) {
      if (langMap.containsKey(question.id)) {
      ...
      final chNum = question.chapterNumber.toString().padLeft(2, '0');
      final qNum = question.questionNumber.toString().padLeft(2, '0');
      final altId = 'ch${chNum}_q$qNum';
      final altShortId = 'q$chNum$qNum';

      if (langMap.containsKey(altId)) return langMap[altId]!;
      if (langMap.containsKey(altShortId)) return langMap[altShortId]!;
    }

    if (localeCode == 'hi') {
      return _generateHindiQuestionFallback(question);
    }
    if (localeCode == 'gu') {
      return _generateGujaratiQuestionFallback(question);
    }
    if (localeCode == 'es') {
      return _generateSpanishQuestionFallback(question);
    }
  ...
  static String _generateHindiQuestionFallback(Question question) {
    ...
    } else if (text.contains('mother') || text.contains('mom')) {
      return 'अपनी माताजी के बारे में बताइए, उनकी सबसे प्यारी बात क्या थी?';
    } else if (text.contains('school') || text.contains('teacher')) {
    ...
    return '$title से जुड़ी अपनी कोई सुंदर याद साझा करें।';
  }
  ...
  static String _generateSpanishQuestionFallback(Question question) {
    final title = _chapterTitles['es']?[question.chapterId] ?? 'Tu Historia';
    return 'Cuéntanos un hermoso recuerdo sobre $title.';
  }
}

extension QuestionL10nExtension on Question {
  String getLocalizedQuestion(String localeCode) {
    return QuestionL10n.getLocalizedQuestion(this, localeCode);
  }
}

extension ChapterL10nExtension on Chapter {
  String getLocalizedTitle(String localeCode) {
    return QuestionL10n.getLocalizedChapterTitle(this, localeCode);
  }
}
